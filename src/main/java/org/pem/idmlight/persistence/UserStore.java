package org.pem.idmlight.persistence;
...
import org.pem.idmlight.IDMLight;
...
public class UserStore {
   ...
   protected Connection dbConnect() throws StoreException {
      if ( dbConnection==null ) {
         try {           
	    Class.forName (IDMLight.idmConfig.dbDriver).newInstance ();
	    dbConnection = DriverManager.getConnection (IDMLight.idmConfig.dbPath); 
            return dbConnection;
         }
         catch (Exception e) {
